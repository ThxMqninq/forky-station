...
job-description-qm = Управляйте снабжением станции и работой отдела логистики, обеспечивайте бесперебойную деятельность утилизаторов, следите за выполнением всех заказов и поддерживайте постоянный приток средств.
...
job-description-serviceworker = Принимайте заказы, обслуживайте клиентов и помогайте сотрудникам других сервисных служб по мере необходимости.
