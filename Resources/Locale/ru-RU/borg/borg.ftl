...
borg-panel-not-open = Панель аутомы не открыта...
...
borg-module-duplicate = Этот модуль уже установлен в эту аутому...
borg-module-whitelist-deny = Этот модуль не подходит для данного типа аутом...
...
borg-construction-guide-string = Конечности и туловище аутомы должны быть прикреплены к эндоскелету.

borg-ui-menu-title = Интерфейс аутомы
...
borg-type-generic-transponder = обычная аутома
...
borg-type-engineering-transponder = аутома-инженер
...
borg-type-mining-transponder = аутома-шахтёр
...
borg-type-janitor-transponder = аутома-уборщик
...
borg-type-medical-transponder = аутома-доктор
...
borg-type-service-transponder = аутома-официант
