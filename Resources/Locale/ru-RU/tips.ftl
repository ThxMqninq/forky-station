...
tips-dataset-81 = Будучи учёным, вы можете делать аутом, используя позитронные мозги.
...
tips-dataset-85 = Будучи врачом, помните, что анализатор здоровья может быть использован если потеряете ваш КПК.
...
tips-dataset-140 = Ящики лотерей редко могут содержать внутри Нагибатор.
