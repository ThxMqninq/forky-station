...
ent-WeaponRifleEstoc = Эсток DMR
    .desc = Марксманская винтовка с режимом стрельбы очередями по два выстрела. Эсток была разработана как винтовка для ведения огня на большие дистанции и оснащена удлиненным 20-дюймовым стволом и оптическим прицелом. Питание осуществляется из магазина под винтовочный патрон калибра .50.
