...
ent-BookSpaceLaw = Корпоративный закон
    ...
    .suffix = { ent-BaseGuidebook.suffix }
ent-BookSentencingGuidelines = вынесение приговоров, судебные процессы и слушания
    .desc = Набор рекомендаций Nanotrasen по обеспечению разумного срока приговоров и своевременного проведения судебных процессов.
