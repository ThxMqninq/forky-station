...
ent-ReinforcementRadioSyndicateCyborgAssault = радио подкрепления штурмовой аутомы Синдиката
    .desc = Призовите хорошо вооружённую штурмовую аутому, немедленно!
    .suffix = Ядерные оперативники
