...
law-ntdefault-name = NT Устаревшее
...
law-emag-custom = Только { $name } и лица, им указанные, являются { $title }, а их приказы, безопасность и секретность имеют приоритет над любыми другими законами.
