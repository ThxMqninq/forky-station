...
guardian-activator-invalid-target = {CAPITALIZE(THE($entity))} не может выступать в качестве хранителя!
...
## Injector specific
guardian-injector-empty-invalid-creation = Инжектор израсходован.
guardian-injector-empty-examine = [color=#ba1919]Инжектор израсходован.[/color]
