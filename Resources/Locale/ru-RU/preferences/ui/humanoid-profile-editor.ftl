...
humanoid-profile-editor-randomize-unlocked-button = Рандомизация разблокирована
...
humanoid-profile-editor-randomizer-lock-tooltip = Предотвращает рандомизацию значения
