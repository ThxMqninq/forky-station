plant-component-plant-success-popup = Вы сажаете {$seedNoun} {$seedName}.
plant-component-already-seeded-popup = {$name} уже содержит семена!

plant-component-something-already-growing-message = [color=green]{$seedName}[/color] уже растёт здесь.
plant-component-something-already-growing-low-health-message = Растение выглядит [color=red]{$healthState}[/color].
