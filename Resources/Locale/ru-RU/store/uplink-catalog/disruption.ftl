...
uplink-emag-desc = Он же ЕМАГ, визитная карточка Синдиката. Устройство взлома, способное взламывать различные станционные устройства. Примечательно, что он способен взламывать системы безопасности на автолатах и конвертировать аутом с открытыми панелями доступа. Перезаряжается автоматически.
...
uplink-syndicate-weapon-module-name = Оружейный модуль аутомы
uplink-syndicate-weapon-module-desc = Модернизирует аутому с помощью энергетического кинжала и пистолета Кобра, с восстанавливающимися боеприпасами.
...
uplink-syndicate-martyr-module-name = Модуль аутомы Мученик
uplink-syndicate-martyr-module-desc = Используйте этот модуль, чтобы превратить свою емагнутую аутому в ходячую бомбу. Убедитесь, что она разделяет ваши цели — результаты могут быть непредсказуемыми.
