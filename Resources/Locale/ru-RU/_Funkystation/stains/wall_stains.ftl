...
wall-stain-pour-start = Вы начинаете осторожно переливать содержимое {$container} на стену...
wall-stain-pour-success = Вы выливаете содержимое {$container} на стену.
