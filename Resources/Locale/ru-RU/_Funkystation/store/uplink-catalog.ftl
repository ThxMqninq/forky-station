...
# Ammo
uplink-pistol-magazine-large-uranium-name = Пистолетный магазин (.50 AE урановые)
uplink-pistol-magazine-large-uranium-desc = Магазин под патрон .50 AE, совместимый с Виверной. Для тех случаев, когда хочется добавить остроты.

uplink-pistol-magazine-large-name = Пистолетный магазин (.50 AE)
uplink-pistol-magazine-large-desc = Магазин под патрон .50 AE, совместимый с Виверной.

uplink-rifle-magazine-50-name = Винтовочный магазин (.50 AE)
