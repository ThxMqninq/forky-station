...
blocking-fraction = Блокируется до [color=lightblue]{ $value }%[/color] входящего урона и:
blocking-coefficient-value = - Получает до [color=lightblue]{ $value }%[/color] [color=yellow]{ $type }[/color] урона.
