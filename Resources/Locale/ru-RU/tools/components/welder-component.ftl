welder-component-welder-not-lit-message = {$owner} выключен!
welder-component-cannot-weld-message = В {$owner} недостаточно топлива для этого!
welder-component-no-fuel-message = В {$owner} не осталось топлива!
welder-component-no-fuel-in-tank = {$target} пуст.
...
welder-component-already-full = {$owner} уже заправлен.
