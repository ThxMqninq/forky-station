...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        Control.AddOptionDropDown(
            QVars.SelectedLobbyShader,
            DropDownLobbyShader,
            [
                new OptionDropDownCVar<int>.ValueOption(1, Loc.GetString("ui-options-lobby-shader-gclouds")),
                new OptionDropDownCVar<int>.ValueOption(2, Loc.GetString("ui-options-lobby-shader-gocean")),
            ]);

        Control.AddOptionColorSlider(QVars.GradientColorTop, TopColorSlider);
        Control.AddOptionColorSlider(QVars.GradientColorBottom, BottomColorSlider);
